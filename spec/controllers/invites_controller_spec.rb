...
describe InvitesController do
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the invites list" #do  Invite.stub!(:find).and_return(mock_invite(:destroy => true))
    it "redirects to the invites list" #do  delete :destroy, :id => "1"
    it "redirects to the invites list" #do  response.should redirect_to(invites_url)
    it "redirects to the invites list" #doend
  end
