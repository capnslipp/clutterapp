...
# 
# Fixes ActionController::Integration::Session#process ThreadError as per <https://rails.lighthouseapp.com/projects/8994/tickets/3153-actioncontrollerintegrationsession-broken-in-234>.
# 
# To use, put this file in lib, then put
#   require 'actioncontroller_integration_session_process_hacks'
# in a
    ...
    module Integration
      class Session
        ...
        def process(method, path, parameters = nil, headers = nil)
          ...
          body.close if body.respond_to?(:close) # added by SlippyD
